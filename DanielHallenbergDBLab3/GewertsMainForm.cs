...
namespace DanielHallenbergDBLab3
{
    public partial class GewertsMainForm : Form
    {
        ...
        public GewertsMainForm()
        {
            ...
            cmbBox_ValdButik.DataSource = DataBaseCommand.PopulateButiker();
        ...
        {         
            ...
            if(!DataBaseCommand.ChangeSaldo(Convert.ToInt32(txt_Ammount.Text), lgSaldo.ISBN, cmbBox_ValdButik.SelectedIndex + 1))
            {
